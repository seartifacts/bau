...
class PatchedFMNIST(data.Dataset):
    def __init__(self, root, mode,
        ...
        if mode == 'test':
            dataset = FashionMNIST(root, train=False, transform=self.transform, download=True)
            self.imgs = dataset.data
            self.labels = dataset.targets
        elif mode == 'train' or mode == 'val':
            dataset = FashionMNIST(root, train=True, transform=self.transform, download=True)
            if mode == 'train':
